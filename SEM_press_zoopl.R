...
# p-value = 0.0007845
dataset_zoopl_press$mean_DN_TP_ratio_100 <- dataset_zoopl_press$mean_DN_TP_ratio*100
hist(dataset_zoopl_press$mean_DN_TP_ratio_100)
...
recovery <- lmer(final_stab_sqrt ~ mean_TP_sqrt + (1|Lake), data=dataset_zoopl_press)

summary(recovery)
# TP p-value = 0.24609 -> singular fit
# TN p-value =  0.3836 -> singular fit
# TN/TP p-value = 0.174 -> singular fit
# DN/TP p-value = 0.810  
...
# TP p-value = 0.3516 
# TN p-value = 0.7756 
# TN/TP p-value = 0.18430   
# DN/TP p-value = 0.28280 
...
# phyto biovolume p-value = 0.1206
# Chl a p-value =  0.871  
...
# testing significance of all variables individually 
AUC <- lmer(total_impact_log ~ phyto_biovolume_log + (1|Lake), data=dataset_zoopl_press)
summary(AUC)
# Chl a p-value = 0.612   -> singular fit
# TP p-value =  0.639 -> singular fit
# TN p-value = 0.342  -> singular fit
# TN/TP p-value = 0.497   -> singular fit
# DN/TP p-value = 0.233   -> singular fit
...
# TP p-value = 0.069  
# TN p-value =  0.0532  
# TN/TP p-value = 0.0601  
# DN/TP p-value = 0.101918  
# DOC p-value = 0.57  
# PAR p-value = 0.0318 !
# Temp p-value = 0.00961 !
# phyto biovolume p-value = 0.5426 
# Chl a p-value = 0.00781 !

# --> PAR, Temp, Chl a 

test <- lm(mean_biomass_log ~ mean_PAR_log + mean_Temp + mean_Chla_log, data=dataset_zoopl_press)
vif(test)
#  mean_PAR_log     mean_Temp mean_Chla_log 
# 1.246924      1.321475      1.190259 
...
# TP p-value = 0.6377 
# TN p-value = 0.55486  
# TN/TP p-value = 0.729292  
# DN/TP p-value = 0.586  
# DOC p-value = 0.05769  
# PAR p-value = 0.582156  
# Temp p-value = 0.0571 
# phyto biovol p-value = 0.271 
