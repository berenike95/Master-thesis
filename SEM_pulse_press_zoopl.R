...
resistance <- lmer(initial_stab_log ~ mean_s + (1|Lake), data=zoopl_pulse_press)
...
evenness <- lmer(mean_J ~ mean_TN_TP_ratio_100 +  (1|Lake), data=zoopl_pulse_press)
ENS <- lmer(mean_ENS_D ~ mean_TN_TP_ratio_100 + (1|Lake), data=zoopl_pulse_press)
richness <- lmer(mean_s ~ mean_TN + mean_DOC + (1|Lake), data=zoopl_pulse_press)
...
# excluding phyto biovolume and AUC because of singular fit 
