...
resistance <- lmer(initial_stab_log ~ mean_s + mean_TN + (1|Lake), data=dataset_zooplankton_pulse)
...
resistance <- lmer(initial_stab_log ~ mean_TN + (1|Lake), data=dataset_zooplankton_pulse)
...
# DOC excluded from model, because of singular fit
