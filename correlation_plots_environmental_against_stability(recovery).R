...
## Environmental parameters ~ stability (recovery) correlation plots ####
...
## 7. TP ~ stability(recovery) for pulse & press ####
...
plot_TP_phyto_recovery <- ggplot(data=function_env_stability_phyto, aes(x=final_stab, 
                                                                        y=TP, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
  xlab("Stability (recovery)") +
...
plot_TP_zoop_recovery <- ggplot(data=function_env_stability_zoop, aes(x=final_stab, 
                                                                      y=TP, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
plot_TP_bact_recovery <- ggplot(data=function_env_stability_bact, aes(x=final_stab, 
                                                                      y=TP, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
grid.arrange(plot_TP_phyto_recovery, plot_TP_zoop_recovery, plot_TP_bact_recovery, ncol = 2)

#-------------------------------------------------------------------------------------------#

## 8. TN ~ stability(recovery) for pulse & press ####

#-------------------------------------------------------------------------------------------#

# TN for phytoplankton

plot_TN_phyto_recovery <- ggplot(data=function_env_stability_phyto, aes(x=final_stab, 
...
plot_TN_zoop_recovery <- ggplot(data=function_env_stability_zoop, aes(x=final_stab, 
                                                                      y=TN, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
plot_TN_bact_recovery <- ggplot(data=function_env_stability_bact, aes(x=final_stab, 
                                                                      y=TN, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
grid.arrange(plot_TN_phyto_recovery, plot_TN_zoop_recovery, plot_TN_bact_recovery, ncol = 2)

#-------------------------------------------------------------------------------------------#

## 9. DOC ~ stability(recovery) for pulse & press ####

#-------------------------------------------------------------------------------------------#

# DOC for phytoplankton

plot_DOC_phyto_recovery <- ggplot(data=function_env_stability_phyto, aes(x=final_stab, 
...
plot_DOC_zoop_recovery <- ggplot(data=function_env_stability_zoop, aes(x=final_stab, 
                                                                       y=DOC, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
plot_DOC_bact_recovery <- ggplot(data=function_env_stability_bact, aes(x=final_stab, 
                                                                       y=DOC, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
grid.arrange(plot_DOC_phyto_recovery, plot_DOC_zoop_recovery, plot_DOC_bact_recovery, ncol = 2)

#-------------------------------------------------------------------------------------------#

## 10. Temperature ~ stability(recovery) for pulse & press ####

#-------------------------------------------------------------------------------------------#

# Temp for phytoplankton

plot_Temp_phyto_recovery <- ggplot(data=function_env_stability_phyto, aes(x=final_stab, 
...
# Temp for Zooplankton

plot_Temp_zoop_recovery <- ggplot(data=function_env_stability_zoop, aes(x=final_stab, 
                                                                        y=Temperature, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
plot_Temp_bact_recovery <- ggplot(data=function_env_stability_bact, aes(x=final_stab, 
                                                                        y=Temperature, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
grid.arrange(plot_Temp_phyto_recovery, plot_Temp_zoop_recovery, plot_Temp_bact_recovery, ncol = 2)

#-------------------------------------------------------------------------------------------#

## 11. PAR ~ stability(recovery) for pulse & press ####

#-------------------------------------------------------------------------------------------#

# PAR for phytoplankton

plot_PAR_phyto_recovery <- ggplot(data=function_env_stability_phyto, aes(x=final_stab, 
...
plot_PAR_zoop_recovery <- ggplot(data=function_env_stability_zoop, aes(x=final_stab, 
                                                                       y=PAR_I, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
plot_PAR_bact_recovery <- ggplot(data=function_env_stability_bact, aes(x=final_stab, 
                                                                       y=PAR_I, color = Treatment, shape = Lake)) +
  labs(color = "Treatment") +
  geom_point() +
  geom_smooth(method = 'lm', aes(group = Treatment)) +
...
grid.arrange(plot_PAR_phyto_recovery, plot_PAR_zoop_recovery, plot_PAR_bact_recovery, ncol = 2)
#-------------------------------------------------------------------------------------------#
